 ...
 */
    public class TicketRezervasyonApp {
        public static void main(String[] args) {

     // 1- Bilet rezervasyonu yapmak için otobüse ihtiycamız var
            Bus bus = new Bus("34 ASD 789");
     // 2- Bilet objesini olusturalım
        ...
        private static void start(Bus bus, Ticket bilet) {
            ...
            do {
                ...
                System.out.println("Lütfen bir koltuk numarası seçiniz : (1-32)\nTekli koltuk ücreti %20 daha fazladır.");
                System.out.println(bus.seats);// mevcut koltuk no'ları
